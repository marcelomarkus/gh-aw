...
hero:
  title: GitHub Agentic Workflows
  tagline: <strong>Repository automation, running coding agents with strong guardrails in GitHub Actions.</strong>
  actions:
...
GitHub Agentic Workflows deliver this: automated repository agents, running coding agents like GitHub Copilot CLI, Claude by Anthropic, and OpenAI Codex, in GitHub Actions, with strong guardrails and security-first design principles.
